...
country-level surveillance of COVID-19 dynamics. Its content should not be used
for publications without explicit aggreement from the authors. The accuracy of
the estimates provided in these analyses is contingent on data quality and
availability. Results presented here do not represent the official view of the
WHO, its staff or consultants.

Countries, territories and areas as reported here do not imply the expression of
