...
ELR_table <- ELR %>% 
  ...
  save_as_image(ELR_table, here("outputs", "ELR_outputs", str_glue("who_ELR_table_{max(ELR$week, na.rm=T)}.png")))
...
ELR %>% 
  ...
  labs(title = "Number of countries classified as Critical, Very high, or High",
       subtitle = "Note: this impacts the workload of Intel team")
...
Classification over time by country, colored by the current ELR classification (global)  

note: This can be difficult to read with all the countries - see regional-specific alluvial plots in their respective section below.  
