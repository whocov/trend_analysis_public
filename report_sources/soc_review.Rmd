...
file_name <- sprintf("dynamics_synthesis_%s.xlsx",
                     Sys.Date())
path_out <- here::here("synthesis", file_name)
rio::export(out_full, file = path_out)

## make a copy as latest file
latest_file_name <- "dynamics_synthesis_latest.xlsx"
latest_path_out <- here::here("synthesis", latest_file_name)
