...
write_csv(out_final, here::here("dynamics_outputs/csv/dynamics_synthesis.csv"), na = "")

## export asmodee summary (dated)
rio::export(out_final, file = here::here(paste0("dynamics_outputs/csv/dynamics_synthesis_", Sys.Date(), ".csv")))
