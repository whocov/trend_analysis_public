...
```{r asmodee-periodic, fig.align='center', echo=FALSE, fig.cap = cap, out.width = "50%"}
...
```{r asmodee-change, fig.align='center', echo=FALSE, fig.cap = cap, out.width = "50%"}
...
class(models) # this is a list
length(models) # each component is a model
models %>% lapply(get_formula) # check all formulas
